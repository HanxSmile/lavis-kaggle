...
from .modules import UNetMIMO2DConditionModel
import inspect
import torch
import random
import logging
...
class OOTDVitonNet(Blip2Base):
    ...
    def __init__(
        ...
        self.unet_garm = UNetMIMO2DConditionModel.from_pretrained(garm_model_name or model_name, subfolder="unet")
        self.unet_vton = UNetMIMO2DConditionModel.from_pretrained(vton_model_name or model_name, subfolder="unet")
