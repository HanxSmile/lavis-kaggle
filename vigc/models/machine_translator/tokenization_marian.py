...
from vigc.models.machine_translator.vocab_extractor import SentencePieceExtractor
...
class MarianTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        extractor = SentencePieceExtractor(
            src_model=source_spm,
            tgt_model=target_spm,
        )
        vocab = extractor.extract()
        self.encoder = vocab
