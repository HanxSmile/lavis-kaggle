...
@registry.register_model("llama3_instruct")
class Llama3Instruct(Blip2Base):
    """
    ...
    Usage:
        ...
        >>> model = load_model("llama3_instruct", "default")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "default": "configs/models/llama/llama3_instruct.yaml",
    }
    ...
    def __init__(
        ...
        self.tokenizer = PreTrainedTokenizerFast.from_pretrained(model_name, use_fast=False, truncation_side="left")
        self.tokenizer.add_special_tokens({'pad_token': '<|end_of_text|>'})
        self.model = LlamaForCausalLM.from_pretrained(model_name, torch_dtype=self.compute_type)
    ...
    def from_config(cls, cfg):
        model_name = cfg.get("model_name", "meta-llama/Llama-3.2-3B-Instruct")
